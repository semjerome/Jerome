...
1.2 Scope
------------------------
The "Telematics" is a hardware that helps the police, Insurance Company and user to determine the cause of a car incident. The hardware will have 3 cameras, one on each side and one on the rear. It will also have an android application where the user can review any previous incident that has happened and add more information if needed. 
...
Furthermore, the user will be able to access the information to through their android phone. From there, they need to log in in order to retrieve the information related to their account. From there on, the user can review the incident and add information about the incident like, the driver's information and car information. If the user does not have an android phone, they can do everything that was mentioned before through the official website.
